...
for i in range(len(jp_values)):
    ...
    Mat_values.append(T_f)

with open('./5/test5_matrix.pickle','wb') as fp:
    pickle.dump(Mat_values,fp)

with open('./5/test5_matrix.pickle','rb') as fp:
    matrix_values = pickle.load(fp)
